...
//             Vector3Int cellPos = new Vector3Int (x, y, z) - Vector3Int.one;
...
//             byte[] indexOffset = regularCell.GetIndices (); //the vertex sequences for the cell
...
//                 byte v0 = (byte) ((vertexPositions[i] >> 4) & 0x0F); //corner a of edge
//                 byte v1 = (byte) ((vertexPositions[i]) & 0x0F); //corner b of edge
...
//                 for (int i = 0; i < 3; i++) {
//                     triangleIndices.Add (mappedIndizes[regularCell.GetIndices () [t * 3 + i]]);
//                 }
//             }
